  ...
  return (
    <div className="guide-page">
      ...
      <section className="guide-section" id="look">
        ...
        />
        <p className="guide-note">מסך שבת מוצג רק בשישי ובשבת, גם אם הוא דלוק. מסך עומר — רק בימי העומר. מסך צום — רק בצום ציבורי (לא יום כיפור), עם שם הצום, תחילה, סוף, ומנחה מהלו״ז.</p>
      </section>
