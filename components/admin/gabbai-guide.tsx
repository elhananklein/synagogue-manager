  ...
  return (
    <div className="guide-page">
      ...
      <section className="guide-section" id="prayers">
        ...
        <Change
          field="סוג התפילה"
          meaning="בחול: סליחות, שחרית, מנחה, ערבית. בשבת: מנחה ערב שבת (בערב חג: מנחה ערב חג), שחרית שבת, מנחה שבת, ערבית מוצ״ש. הסדר על המסך לפי סדר היום."
        />
        <Change
          field="ימים"
        ...
        <Change
          ...
          meaning="רק למנחה ולערבית של חול. השעה מגיעה מטבלת הפרשות למטה — נשמרת בלחצן נפרד. בצום ציבורי (גדליה, י״ז בתמוז, עשרה בטבת, תענית אסתר, תשעה באב, בכורות) נלקחת שורת «צום» אם מילאתם אותה."
        />
        <p className="guide-note">בצום מוצג מסך ייעודי: שם הצום, תחילת הצום, סוף הצום, ותפילת מנחה לפי הלו״ז (שורת «צום» בקטלוג אם מולאה). תחילת הצום: עלות השחר; בתשעה באב — שקיעת אתמול. סוף הצום: צאת הכוכבים.</p>
      ...
      <section className="guide-section" id="shabbat">
        <h2>שבתות וחגים</h2>
        <p>רשימה חופשית לימי שבתון ברצף — עד שלושה ימים (יום טוב ו/או שבת צמודים). ערב היום הראשון אינו בלוק נפרד: הוא מתנהג כמו ערב שבת ומציג את יום א׳.</p>
        <Where
          wall="מסך שבת וחגים — בערב היום הראשון, בימי השבתון, בשישי ובשבת"
          phone="כרטיס שבת וחגים — באותם ימים"
        />
        <div className="guide-links">
          <Link href={`${base}/shabbat`}>פתיחת לוח שבתות וחגים</Link>
        </div>
        <Change field="יום א׳ / ב׳ / ג׳" meaning="כל יום שבתון הוא לוח נפרד. בראש השנה חמישי–שישי ואז שבת יהיו שלושה ימים. שבת רגילה נשארת יום אחד." />
        <Change field="הוספת יום" meaning="מוסיפים יום שני או שלישי כשמכינים מועד ארוך מראש. יום בלי שורות לא מוצג על הקיר." />
        <Change field="העתק מהיום הקודם" meaning="משכפל שעות ותוכן ליום הבא, למשל מיום א׳ של ראש השנה ליום ב׳." />
        <Change field="שעה" meaning="לא חובה. אם יש שעה היא מוצגת ליד התוכן, גדולה על הקיר." />
        <Change field="מה קורה" meaning="הטקסט שהציבור רואה. למשל קבלת שבת, קריאת התורה, קידוש. זמני ערב היום הראשון נכתבים ביום א׳." />
        ...
        />
        <p>בעמודות: בשבת רגילה «ערב שבת» ו«ביום השבת». בחג (גם כשחל בשבת) «ערב חג» ו«חג - בוקר».</p>
        <p>בעמודה השלישית: ביום שאינו אחרון ברצף נכתב «מנחה עד סוף היום». ביום האחרון — «מנחה עד מוצ״ש» אם הוא שבת, אחרת «מנחה עד מוצאי החג».</p>
      ...
      <section className="guide-section" id="look">
        ...
        />
        <p className="guide-note">מסך שבת מוצג רק בשישי ובשבת, גם אם הוא דלוק. כשהוא פעיל, עמודת הזמנים במסך הראשי מוסתרת (נשארים פרשה, תוספות ודף יומי); בשישי הזמנים נשארים עד חצות היום. מסך עומר — רק בימי העומר. מסך צום — רק בצום ציבורי (לא יום כיפור), עם שם הצום, תחילה, סוף, ומנחה מהלו״ז.</p>
      </section>
