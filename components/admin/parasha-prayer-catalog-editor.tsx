    ...
    <div className="relative space-y-3 rounded-md border border-border p-4">
      ...
      <div>
        ...
        <p className="mt-1 text-xs text-muted-foreground">
          ממלאים את 54 הפרשות, חול המועד, ושורת «צום» למנחה/ערבית ביום תענית. אין צורך בקטלוג נפרד לכל שנה:
          בשבוע של פרשות מחוברות נלקחת שעת הפרשה הראשונה בזוג, ואם אין — השנייה. שורה של הזוג עצמו (למשל
          מטות־מסעי) דורסת את זה לאותו זיווג. השמירה מחליפה את כל הקטלוג של המניין. תא ריק חוזר לכלל הרגיל של
          התפילה.
        </p>
      </div>
